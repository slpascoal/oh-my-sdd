...
This last point is exactly what `oh-my-sdd-implement` does at the end of its run: it compares the code it just wrote against the acceptance criteria checklist in `spec.md` and reports which ones were met.
